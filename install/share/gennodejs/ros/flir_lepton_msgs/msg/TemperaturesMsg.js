...
class TemperaturesMsg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TemperaturesMsg(null);
  ...
  static datatype() {
    ...
    return 'flir_lepton_msgs/TemperaturesMsg';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'f3b9f8ea9fd00211ddae6dc9f7773488';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TemperaturesMsg(null);
...
module.exports = TemperaturesMsg;
